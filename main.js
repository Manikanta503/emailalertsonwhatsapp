...
function listMessages(auth, query){
  query = 'manikantabandreddy3@gmail.com';
  //place your gmail id in 96th line code
  return new Promise((resolve, reject) => {    
    const gmail = google.gmail({version: 'v1', auth});
    gmail.users.messages.list(      
      {        
        userId: 'me',  
        q:'manikantabandreddy3@gmail.com is:unread',  
        //place your gmail id in 102 line    
        maxResults:1     
      },  (err, res) => {        
                    if (err) {        
                        reject(err);          
...
async function whatsapp(params) {
    ...
    const data1 = await fetch(
        "https://api.callmebot.com/whatsapp.php?phone=+917993657715&text="+message+"&apikey=634186"
        //set your callmebot api in 146 line
    );
    console.log(data1);
}
